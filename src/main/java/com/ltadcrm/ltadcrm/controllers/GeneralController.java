...
public class GeneralController {
    ...
    @ResponseStatus(OK)
    @GetMapping
    public List<ItemsDTO> showAllDTO() throws Exception {
        return readMethod.list();
    }

    @ResponseStatus(CREATED)
    @PostMapping("/create")
    public String saveMethod(@RequestBody ItemsDTO itemsDTO) {
        return createMethod.create(itemsDTO);
    }
    ...
    public ListWithTotalValues<CostCenterByNameDTO> getMethodName(@PathVariable String name)
            throws Exception {
    ...
    public ResponsibleDTO registerResponsible(@RequestBody ResponsibleDTO responsibleDTO)
            throws Exception {
